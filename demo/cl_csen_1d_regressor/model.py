...
from cl_csen_1d_regressor.utils import *

class model:
    def __init__(self):
        self.imageSizeM = None
        self.model = None
        self.history = None
        self.x_train = None
        self.x_val = None
    ...
    def getModel(self):
        ...
        x_0 = tf.keras.layers.Dense(self.imageSizeM, activation = 'relu')(input)
    ...
    def load_weights(self, weightPath):
        if self.model is None: self.getModel()
